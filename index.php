    							...
    							<div class="top-cart-title">
                                    ...
                                    <div class="infor-cart">
                                    	<a class="dropdown-toggle">
                							Giỏ hàng
            								<span class="price">150.000VND</span>
            							</a>
                                    </div>
                                </div>
                                <div class="shopping-cart">
                					<div class="shopping-cart-header">
                                        <span class="badge"><?php echo $count= $cart->getNumItem();?> Sản Phẩm</span>
                                    </div>
                					<ul class="shopping-cart-items">
                                    <!--sp-->
                  						<li class="clearfix">
                                    		 <img src="images/products/Pizza/Phomai/Margherita.png" />
                                    		 <span class="item-name">Pizza Phomai L</span>
                                   			 <span class="item-price">Giá: 75000VND</span>
                                    		 <span class="item-quantity">Số lượng: 01</span>
                  						</li>
                                      
                					</ul>
                					<a href="index.php?mod=cart" class="button">Kiểm tra</a>
									<script src='js/jquery-3.1.1.min.js'></script>
                                    <script src="js/box-cart.js"></script>
							</div>
                        </div>	
                    </div>
                    <div class="clear"></div>
                    <div class="menu-top">
                        ...
                        <div class="fright">
                            ...
                            <form action="index.php" method="post">
                                ...
                                <button type="button" class="button-search" name="bnsearch"></button>
                            </form>
                            </div>
                        </div>
                    </div>
